...
var EditOfferPage = /** @class */ (function () {
    function EditOfferPage(route, navCtrl, placeService, loadingCtrl) {
        this.route = route;
    ...
    EditOfferPage.prototype.ngOnInit = function () {
        ...
        this.route.paramMap.subscribe(function (param) {
            ...
            _this.placeService.getPlace(param.get('placeId')).subscribe(function (place) {
                _this.place = place;
            });
        });
    ...
    EditOfferPage.prototype.onUpdate = function () {
        var _this = this;
        console.log(this.form);
        if (!this.form.valid) {
            return;
        }
        var _a = this.form.value, title = _a.title, description = _a.description;
        this.loadingCtrl.create({
            message: 'loading...'
        }).then(function (loadingEl) { return loadingEl.present(); });
