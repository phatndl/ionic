        ...
        children: [
            ...
            },
            {
                ...
                children: [
                    ...
                    {
                        path: ':placeId',
                        loadChildren: function () { return Promise.all(/*! import() | offers-offer-booking-offer-booking-module */[__webpack_require__.e("common"), __webpack_require__.e("offers-offer-booking-offer-booking-module")]).then(__webpack_require__.bind(null, /*! ./offers/offer-booking/offer-booking.module */ "./src/app/places/offers/offer-booking/offer-booking.module.ts")).then(function (m) { return m.OfferBookingPageModule; }); }
                    }
                ]
            },
            {
