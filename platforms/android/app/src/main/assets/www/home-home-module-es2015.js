            ...
            _angular_router__WEBPACK_IMPORTED_MODULE_5__["RouterModule"].forChild([
                {
                    ...
                    children: [
                        {
                            path: 'page-one',
                            loadChildren: () => __webpack_require__.e(/*! import() | page-one-page-one-module */ "page-one-page-one-module").then(__webpack_require__.bind(null, /*! ./page-one/page-one.module */ "./src/app/home/page-one/page-one.module.ts")).then(m => m.PageOnePageModule)
                        },
                        {
                            path: 'page-two',
                            loadChildren: () => __webpack_require__.e(/*! import() | page-two-page-two-module */ "page-two-page-two-module").then(__webpack_require__.bind(null, /*! ./page-two/page-two.module */ "./src/app/home/page-two/page-two.module.ts")).then(m => m.PageTwoPageModule)
                        },
                    ]
                }
            ])
