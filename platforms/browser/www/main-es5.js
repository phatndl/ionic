...
var routes = [
    { path: '', redirectTo: 'recipes', pathMatch: 'full' },
    {
        ...
        children: [
            {
                path: '',
                loadChildren: function () { return Promise.all(/*! import() | recipes-recipes-module */[__webpack_require__.e("common"), __webpack_require__.e("recipes-recipes-module")]).then(__webpack_require__.bind(null, /*! ./recipes/recipes.module */ "./src/app/recipes/recipes.module.ts")).then(function (m) { return m.RecipesPageModule; }); }
            },
            {
                path: ':recipeId',
                loadChildren: function () { return Promise.all(/*! import() | recipes-recipe-detail-recipe-detail-module */[__webpack_require__.e("common"), __webpack_require__.e("recipes-recipe-detail-recipe-detail-module")]).then(__webpack_require__.bind(null, /*! ./recipes/recipe-detail/recipe-detail.module */ "./src/app/recipes/recipe-detail/recipe-detail.module.ts")).then(function (m) { return m.RecipeDetailPageModule; }); }
            }
        ]
    },
];
...
module.exports = __webpack_require__(/*! /Users/phatndl/Desktop/dev/ionic/ionic-angular/src/main.ts */"./src/main.ts");
